...
export class Setup extends Component {
  ...
  uploadHomeBackgroundImg = () => {
    ...
    if (uploadHomeBackgroundImage === "") {
      ...
      imagesRef
        .child("homeBackgroundImage")
        .put(uploadHomeBackgroundImage)
        .then((snapshot) => {
          imagesRef
            .child("homeBackgroundImage")
            .getDownloadURL()
          ...
          .then((snapshot) => {
            imagesRef
              ...
              .then((aDUrl) => {
                ...
                if (
                  uploadAdverts.indexOf(uploadAdvert) ===
                  uploadAdverts.length - 1
                ) {
                  this.updateSettings();
                }
              });
    ...
    switch (this.state.activeStep) {
      case 0:
        if (this.state.businessCategory === "None") {
          ...
          if (
            this.state.businessCategory === "Multi-Tenant Office Building" &&
            this.state.businessMultiOffices === ""
          ) {
            this.setState((state) => ({
  ...
  handleCloseColorDialog = () => {
    ...
    let newColor =
      this.state.activeColorSelect === "Primary Color"
  ...
  handleAdvertDelete = (index, advert, advertName) => {
    let filteredAdvertsUrl = this.state.advertImagesUrl.filter(
      (advertItem) => advertItem !== advert
    );

    let filteredAdverts = this.state.advertImages.filter(
      (advertItem) => this.state.advertImages.indexOf(advertItem) !== index
    );

    let filteredAdvertNames = this.state.advertImages.filter(
      (advertNameItem) => advertNameItem !== advertName
    );
          ...
          <div className='setup-sidebar'>
            <div>
              ...
              <div className='setup-sidebar-content'>
                <p>
                  Configure a setting to be applied. This will
                  give a unique look and feel 
                </p>

                <p>
                  You can modify or add more configurations at anytime from the
                  settings tab on your console.
                </p>

                <p>
                  Upload your Logo, change background images, edit Bio fields,
                  upload advert images etc.
                </p>
              ...
              <div className='setup-configure'>
                <div>
                  {activeStep === 0 ? (
                    ...
                    <div>
                      <h5 className='nMP'>
                        Your Brand Primary and Secondary Colors
                      </h5>
                      <p className='colorC'>
                        Click on the color circles to pick and change
                      </p>
                      <p className='colorC'>
                    ...
                    <div>
                      <h5 className='nMP'>
                        Logo and Background Image for Landing Screen
                      </h5>
                      <div className='setup-configure-fields'>
                        <CompanyAssets
                          name='logoImage'
                        ...
                        <CompanyAssets
                          ...
                          onDelete={() =>
                            this.handleAssetDelete("backgroundImage")
                          }
                        />
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className='setup-configure-fields'>
                        <CompanyAdverts
                          ...
                          onDelete={(index, advert, advertName) =>
                            this.handleAdvertDelete(index, advert, advertName)
                          }
                        />
                        <p
                          style={{
                    ...
                    <div>
                      ...
                      <div className='setup-configure-fields'>
                        <Form
                          ...
                          idf='bioForm'
                          fields={this.state.fields}
                          formOnChange={(form, formidf) =>
                            this.handleFormChange(form, formidf)
                          }
                          fieldOnChange={(form, formidf, index) =>
                            this.handleFieldChange(form, formidf, index)
                          }
                        />
                      </div>
                    </div>
                      ...
                      <div className='setup-configure-fields'>
                        ...
                        >
                          {this.state.fields.inputParams["4takePicture"]
                            ...
                            : "The Visitors picture will not be required."}
                        </p>
                      </div>
                    </div>
                  ) : activeStep === 9 ? (
                      ...
                      <div className='setup-configure-fields'>
                        ...
                        >
                          {this.state.fields.inputParams["5signaturePad"]
                            ...
                            : "The Visitors signature will not be required."}
                        </p>
                      </div>
                    </div>
                  ) : activeStep === 10 ? (
                    <div>
                      ...
                      <div className='setup-configure-fields'>
                        ...
                        >
                          Changes cannot be made to the Tag Form. This is to
                          match the visitor Sign Out with the Sign In
                          credentials.
                        </p>
...
//   const [logoImageUrl, setLogoImageUrl] = useState(DefaultSettings.logoImageDownloadUrl);
//   const [backgroundImageUrl, setBackgroundImageUrl] = useState(DefaultSettings.backgroundImageDownloadUrl);
...
//   const [businessMultiOffices, setBusinessMultiOffices] = useState("");
//   const [businessMultiOfficesArray, setBusinessMultiOfficesArray] = useState([]);
//   const [businessMultiOfficesError, setBusinessMultiOfficesError] = useState(false);
//   const [businessMultiOfficesChange, setBusinessMultiOfficesChange] = useState(false);
...
//   const [purposeOfVisitOptions, setPurposeOfVisitOptions] = useState(DefaultSettings.purposeOfVisitOptions);
